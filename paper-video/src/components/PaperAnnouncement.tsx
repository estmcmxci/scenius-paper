  ...
  return (
    <div
      style={{
        ...
        alignItems: "center",
        height: "100%",
        padding: portrait ? "0 72px" : "0 140px",
        gap,
      }}
    >
      {children}
    ...
    <CenterStack>
      <FadeUp delay={8}>
        ...
        >
          ...
          <span style={{ fontWeight: 600, fontSize: portrait ? 68 : 90 }}>money talks.</span>
        </div>
      </FadeUp>
    </CenterStack>
  );
...
// ─── Scene 1: Equation reveal ────────────────────────────────

const SceneEquation: React.FC = () => {
  const { width, height } = useVideoConfig();
  const portrait = height > width;
  ...
  return (
    <CenterStack gap={44}>
      ...
      <FadeUp delay={12}>
        <div style={{ fontSize: portrait ? 58 : 80, ...mathBase, textAlign: "center" }}>
      ...
      <FadeUp delay={28}>
        ...
        >
          the crowd's forecast, weighted by how much they bet
        </div>
      </FadeUp>
    </CenterStack>
  );
...
const SceneQuestion: React.FC = () => {
  ...
  return (
    <CenterStack gap={48}>
      ...
      <FadeUp delay={22}>
        <div style={{ fontSize: portrait ? 42 : 58, ...mathBase, textAlign: "center" }}>
          Brier(p<Sup>C</Sup>)
          <Op>&lt;</Op>
          Brier(p<Sup>E</Sup>)
          <Op>?</Op>
...
const SceneProblem: React.FC = () => {
  ...
  return portrait ? (
    <CenterStack gap={36}>
      ...
      <FadeUp delay={28}>
        <div style={{ fontSize: 34, ...mathBase, textAlign: "center", whiteSpace: "nowrap" }}>
...
const SceneClaim: React.FC = () => {
  ...
  return portrait ? (
    <CenterStack gap={32}>
      ...
      <FadeUp delay={52}>
        <div style={{ fontSize: 54, ...mathBase, textAlign: "center" }}>
...
const SceneEndCard: React.FC = () => {
  ...
  const dividerWidth = interpolate(dividerProgress, [0, 1], [0, portrait ? 400 : 600]);
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100%", backgroundColor: colors.bg }}>
      ...
      >
        ...
        <FadeUp delay={34}>
          <div style={{ fontFamily: dmSans, fontSize: portrait ? 18 : 22, color: colors.textTertiary, textAlign: "center" }}>
...
// ─── Main composition ────────────────────────────────────────
//
// Scene 0: Hook text (0-89, 3s)
// Scene 1: Equation (90-179, 3s)
// Scene 2: Question (180-269, 3s)
// Scene 3: Problem (270-389, 4s)
// Scene 4: Claim (390-509, 4s)
// Scene 5: End card (510-629, 4s)
...
export const PaperAnnouncement: React.FC = () => {
  ...
  let activeScene = 0;
  if (frame >= 510) activeScene = 5;
  else if (frame >= 390) activeScene = 4;
  ...
  return (
    ...
    >
      ...
      <Sequence from={90} durationInFrames={90}>
        ...
        <SlideScene exitStart={72}><SceneEquation /></SlideScene>
      </Sequence>
      ...
      <Sequence from={270} durationInFrames={120}>
        ...
        <SlideScene exitStart={102}><SceneProblem /></SlideScene>
      </Sequence>
      ...
      <ProgressDots active={activeScene} total={6} />
    </div>
  );
};
